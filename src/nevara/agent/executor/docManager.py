...
from nevara.manager import DocManager

docManager = DocManager()

#### TOOLS ####
search_on_all_doc = StructuredTool.from_function(
    func=docManager.search_on_all_doc,
)

search_on_doc = StructuredTool.from_function(
    func=docManager.search_on_doc,
)
